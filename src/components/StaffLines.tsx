    ...
    <div className="relative">
      <svg width={width} height={height}>
        {clefType === 'treble' ? (
          ...
          // Clave de Fa
          <g transform={`translate(15, ${height/2 + 10}) scale(0.04)`}>
            <path
              d="M17.3 27.1c-1.8-0.3-3.7-0.4-5.6-0.4c-7.8 0-14.2 2.9-14.2 8.5c0 4.1 3.2 7.4 7.2 7.4 c4.5 0 8.2-3.7 8.2-8.2c0-0.9-0.2-1.7-0.5-2.5c1.1-0.1 2.2-0.2 3.3-0.2c0.5 0 1 0 1.5 0L17.3 27.1z M12.9 34.4 c0 2.7-2.2 4.9-4.9 4.9c-2.7 0-4.9-2.2-4.9-4.9c0-2.7 2.2-4.9 4.9-4.9C10.7 29.5 12.9 31.7 12.9 34.4z"
              fill="black"
            />
            <circle cx="14" cy="44" r="2" fill="black" />
            <circle cx="14" cy="52" r="2" fill="black" />
          </g>
        )}
